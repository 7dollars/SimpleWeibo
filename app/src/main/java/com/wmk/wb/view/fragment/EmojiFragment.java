...
import com.wmk.wb.R;
import com.wmk.wb.presenter.EmojiFG;
import com.wmk.wb.presenter.adapter.EmojiPagerAdapter;
...
public class EmojiFragment extends Fragment {
    ...
    public interface onEmojiSelect
    {
        void emojiSelect();
    }
    @Override
    ...
    //    view.setBackgroundColor(getResources().getColor(ColorThemeUtils.getColor(instance.getThemeColor())));
